...
INFILE u ($0-0.1):4:(BOXWIDTH) w boxes lc rgb "#FF0000" t "Write", \
INFILE u ($0-0.1):4:2:3 w errorbars lt 7 lc rgb "#FF0000" not, \
INFILE u ($0+0.1):8:(BOXWIDTH) w boxes lc rgb "#0000FF" t "Read", \
INFILE u ($0+0.1):8:6:7 w errorbars lt 7 lc rgb "#0000FF" not
